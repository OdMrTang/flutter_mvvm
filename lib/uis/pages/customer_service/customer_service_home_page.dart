...
import 'package:jvtd_shop_client/view_model/customer_service/customer_service_home_model.dart';
...
class _CustomerServiceHomepageState extends State<CustomerServiceHomepage> {
  ...
  Widget build(BuildContext context) {
    return ProviderWidget<CustomerServiceHomeModel>(
        ...
        model: CustomerServiceHomeModel());
  }
}
